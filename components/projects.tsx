  ...
  return (
    <section className="section projects" id="projects">
      ...
      <div className="project-holder">
        <ProjectCard
          img={"https://firebasestorage.googleapis.com/v0/b/pushy-9740f.appspot.com/o/portfolio%2Fsrm%20vec%20website.png?alt=media&token=f244dd0b-f3c3-4472-92f4-5b7b7d590638"}
        ...
        />
        <ProjectCard
          img={"https://firebasestorage.googleapis.com/v0/b/pushy-9740f.appspot.com/o/portfolio%2Fslt%20project.png?alt=media&token=cc030efb-aee6-4e73-a4a6-c8fa964c6655"}
        ...
        />
        <ProjectCard
          img={"https://firebasestorage.googleapis.com/v0/b/pushy-9740f.appspot.com/o/portfolio%2Flendbook.png?alt=media&token=5711a259-a077-4799-9436-790e03de4a32"}
          title={"Lendbook"}
